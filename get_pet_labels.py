...
#                                                                             
# PROGRAMMER: Aravindaswamy Anandakumar
# DATE CREATED: 6/29/2024                                 
# REVISED DATE: 6/29/2024
  ...
  # of the file that contain the pet image label
    for idx in range(0, len(in_files), 1):
      ...
      if in_files[idx][0] != ".":
          ...
          name_parts = in_files[idx].lower().split('_')

           # Extract alphabetic parts only, join them with a space
          pet_label = " ".join([part for part in name_parts if part.isalpha()]).strip()
